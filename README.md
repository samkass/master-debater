...
## Usage
1. Enter the OpenAI API key in the sidebar
...
1. TEST_MODE: Instead of calling OpenAPI, will generate a stream of random numbers to simulate a response. Useful for testing without incurring costs from OpenAI.
